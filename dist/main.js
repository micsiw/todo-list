...
const Subtask = (name, dueDate, status = false) => {
    ...
    const getDate = () => {
        if (dueDate === '') {
            ...
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate), 'd/MM/y')
        }
    }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _subtasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./subtasks */ "./src/modules/subtasks.js");
...
const Task = (name, dueDate) => {
    ...
    const getDate = () => {
        if (dueDate === '') {
            ...
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDate), 'd/MM/y')
        }
    }
    ...
    const addSubtask = (name, dueDate, status) => {
        subtasks.push((0,_subtasks__WEBPACK_IMPORTED_MODULE_0__["default"])(name, dueDate, status));
    }
...
function initializeNewProject() {
    ...
    function getProjectName() {
        ...
        actualProject = _projects__WEBPACK_IMPORTED_MODULE_0__.projects[_projects__WEBPACK_IMPORTED_MODULE_0__.projects.length - 1];
        projectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__.projects.indexOf(actualProject);
        initializeWebPage();
    };
