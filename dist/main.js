...
const Project = (name) => {
  ...
  const addTask = (name, dueDate) => {
    tasks.push((0,_tasks__WEBPACK_IMPORTED_MODULE_0__["default"])(name, dueDate));
  };
...
function loadContent() {
  ...
  function loadDefault() {
    const defaultProject = (0,_projects__WEBPACK_IMPORTED_MODULE_0__["default"])("Personal");
    const testProject = (0,_projects__WEBPACK_IMPORTED_MODULE_0__["default"])("Test");
    const schoolProject = (0,_projects__WEBPACK_IMPORTED_MODULE_0__["default"])("School");
    ...
    defaultProject.tasks[2].addSubtask(
      "Fix Ubuntu crashing",
      "2023-03-02",
      false
    );
  ...
  function loadData() {
    ...
    data.forEach((project) => {
      const restored = (0,_projects__WEBPACK_IMPORTED_MODULE_0__["default"])(project.name);
      project.tasks.forEach((task, index) => {
        restored.addTask(task.name, task.dueDate);
        task.subtasks.forEach((subtask) => {
          restored.tasks[index].addSubtask(
            subtask.name,
            subtask.dueDate,
            subtask.status
          );
...
let actualProject = _storage__WEBPACK_IMPORTED_MODULE_0__.projects[0];
let projectIndex = _storage__WEBPACK_IMPORTED_MODULE_0__.projects.indexOf(actualProject);
...
function initializeWebPage() {
  ...
  projectList.addEventListener("change", () => {
    ...
    actualProject = _storage__WEBPACK_IMPORTED_MODULE_0__.projects[selectedOption.dataset.projectId];
  ...
  function initializeNewProject() {
    ...
    function createNewProject() {
      ...
      _storage__WEBPACK_IMPORTED_MODULE_0__.projects.push((0,_projects__WEBPACK_IMPORTED_MODULE_1__["default"])(projectName));
      addProjectFormInput.remove();
      addProjectFormButton.remove();
      removeProjectButton.before(addProjectButton);
      actualProject = _storage__WEBPACK_IMPORTED_MODULE_0__.projects[_storage__WEBPACK_IMPORTED_MODULE_0__.projects.length - 1];
      projectIndex = _storage__WEBPACK_IMPORTED_MODULE_0__.projects.indexOf(actualProject);
      projectInfo.innerHTML = actualProject.getName();
      localStorage.setItem("projects", JSON.stringify(_storage__WEBPACK_IMPORTED_MODULE_0__.projects));
      updateProjectList();
      loadTasks();
    }
  ...
  function deleteActualProject() {
    ...
    if (projectIndex == 0) {
      ...
      if (
        ...
        _storage__WEBPACK_IMPORTED_MODULE_0__.projects.splice(projectIndex, 1);
        actualProject = _storage__WEBPACK_IMPORTED_MODULE_0__.projects[projectIndex - 1];
        projectIndex -= 1;
        localStorage.setItem("projects", JSON.stringify(_storage__WEBPACK_IMPORTED_MODULE_0__.projects));
        updateProjectList();
        loadTasks();
  ...
  function updateProjectList() {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_0__.projects.forEach((project, index) => {
